...
%g_curv=.00005; %.00002; %Media con area
...
Ni=4*ones(1,Ns); %6 hp di Ni costante per ogni span
...
% Visualizzazione dello snake al passo k=0
Imp=ImIn;
Npunti=length(G);
for np=1:Npunti
...
Le=input('Banda esterna = '); 
Li=input('Banda interna = '); 
...
%     quando si vede che siè prossimi alla convergenza.
